...
from project_ai.v3.engine.schema import ModelType, ModelInfo
from loguru import logger
from pathlib import Path

from project_ai.v3.engine.const import (
    DEFAULT_MODEL_DIR,
...
from project_ai.v3.engine.model.original_sd_configs import get_config_files


def cli_download_model(model: str):
    from project_ai.v3.engine.model import models
    from project_ai.v3.engine.model.utils import handle_from_pretrained_exceptions
...
def scan_single_file_diffusion_models(cache_dir) -> List[ModelInfo]:
    ...
    cache_file = stable_diffusion_dir / "projectai_v3_cache.json"
    model_type_cache = {}
    ...
    sdxl_cache_file = stable_diffusion_xl_dir / "projectai_v3_cache.json"
